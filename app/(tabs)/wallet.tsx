...
const ALL_BANK_OPTIONS: WalletCard[] = [
  ...
  { name: 'UnionBank',     subtitle: 'Bank Account · PHP', balance: '₱ 0.00', colors: ['#003087', '#001B55'], image: require('@/assets/images/banks/unionbank.png') },
  { name: 'Security Bank', subtitle: 'Bank Account · PHP', balance: '₱ 0.00', colors: ['#CC0000', '#990000'], image: require('@/assets/images/banks/securitybank.png') },
  { name: 'Landbank',      subtitle: 'Bank Account · PHP', balance: '₱ 0.00', colors: ['#006633', '#004422'], image: require('@/assets/images/banks/landbank.png') },
  { name: 'PNB',           subtitle: 'Bank Account · PHP', balance: '₱ 0.00', colors: ['#8B0000', '#600000'], image: require('@/assets/images/banks/PNB.png') },
  { name: 'RCBC',          subtitle: 'Bank Account · PHP', balance: '₱ 0.00', colors: ['#006B3C', '#004827'], image: require('@/assets/images/banks/RCBC.png') },
